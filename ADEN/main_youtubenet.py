...
from InputFN.input_fn import YouTubeNetData
from Model.baseline_model import YouTubeNetModel
from Solver import estimator_solver
from Utils.params_config import YouTubeNetParams
from Utils import utils

def main(_):
  project_name = 'YouTubeNet'
  seq_params = YouTubeNetParams(project_name)
  seq_params.post_process()
  mode = seq_params.params['mode']

  model_fn = YouTubeNetModel(seq_params.params)
  input_fn = YouTubeNetData(seq_params.params)
