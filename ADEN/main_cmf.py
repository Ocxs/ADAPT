...
from InputFN.input_fn import CMFData
from Model.baseline_model import CMFModel
from Solver import estimator_solver
from Utils.params_config import CMFParams
from Utils import utils

def main(_):
  project_name = 'CMF'
  seq_params = CMFParams(project_name)
  seq_params.post_process()
  mode = seq_params.params['mode']

  model_fn = CMFModel(seq_params.params)
  input_fn = CMFData(seq_params.params)
