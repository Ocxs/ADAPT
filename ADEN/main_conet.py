...
from InputFN.input_fn import CoNetData
from Model.baseline_model import CoNetModel
from Solver import estimator_solver
from Utils.params_config import CoNetParams
from Utils import utils

def main(_):
  project_name = 'CoNet'
  seq_params = CoNetParams(project_name)
  seq_params.post_process()
  mode = seq_params.params['mode']

  model_fn = CoNetModel(seq_params.params)
  input_fn = CoNetData(seq_params.params)
