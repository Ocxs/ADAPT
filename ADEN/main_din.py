...
from InputFN.input_fn import DINData
from Model.baseline_model import DINModel
from Solver import estimator_solver
from Utils.params_config import DINParams
from Utils import utils

def main(_):
  project_name = 'DIN'
  seq_params = DINParams(project_name)
  seq_params.post_process()
  mode = seq_params.params['mode']

  model_fn = DINModel(seq_params.params)
  input_fn = DINData(seq_params.params)
