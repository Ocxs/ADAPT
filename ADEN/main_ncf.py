...
from InputFN.input_fn import NCFData
from Model.baseline_model import NCFModel
from Solver import estimator_solver
from Utils.params_config import NCFParams
from Utils import utils

def main(_):
  project_name = 'NCF'
  seq_params = NCFParams(project_name)
  seq_params.post_process()
  mode = seq_params.params['mode']

  model_fn = NCFModel(seq_params.params)
  input_fn = NCFData(seq_params.params)
