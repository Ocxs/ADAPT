...
from InputFN.input_fn import DIENData
from Model.baseline_model import DIENModel
from Solver import estimator_solver
from Utils.params_config import DIENParams
from Utils import utils

def main(_):
  project_name = 'DIEN'
  seq_params = DIENParams(project_name)
  seq_params.post_process()
  mode = seq_params.params['mode']

  model_fn = DIENModel(seq_params.params)
  input_fn = DIENData(seq_params.params)
