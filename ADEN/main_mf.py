...
from InputFN.input_fn import MFData
from Model.baseline_model import MFModel
from Solver import estimator_solver
from Utils.params_config import MFParams
from Utils import utils

def main(_):
  project_name = 'MF'
  seq_params = MFParams(project_name)
  seq_params.post_process()
  mode = seq_params.params['mode']

  model_fn = MFModel(seq_params.params)
  input_fn = MFData(seq_params.params)
