...
from InputFN.input_fn import DUALInferData
from Model.DUAL import DUALInferModel
from Solver import estimator_solver as estimator_solver
from Utils.params_config import DUALInferParams
from Utils import utils


def main(_):
  project_name = 'DUAL_infer'
  ft_params = DUALInferParams(project_name)
  # ft_params.post_process()
  mode = ft_params.params['mode']

  model_fn = DUALInferModel(ft_params.params)
  input_fn = DUALInferData(ft_params.params)
